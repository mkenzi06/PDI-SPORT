...
import modele.TestJfreeChTimeWind;
import modele.VitesseWind;
...
// Créer un tableau pour stocker les performances spécifiques au cyclisme
        List<Performances> performancesWindsurf = new ArrayList<>();

// Filtrer les performances pour ne garder que celles liées au cyclisme
        for (Performances performance : performancesUtilisateur) {
            if (performance.getSport().estWindsurf()) {
                performancesWindsurf.add(performance);
            }
        }
        ...
        for (Performances performance : performancesWindsurf) {
            Object[] row = new Object[3];
            row[0] = performance.getDate();
            row[1] = ((WindSurf) performance.getSport()).getDistanceParcourue();
            row[2] = ((WindSurf) performance.getSport()).getTempsPerformance();
            model.addRow(row);
        }
    ...
    private void initComponents() {
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(515, 59, -1, 280));
        ...
        getContentPane().add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(554, 395, -1, -1));
        ...
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 30, 270, 70));
        ...
        jPanel1.add(jCalendar1, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 230, -1, -1));
        ...
        jPanel1.add(dparcour, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 120, 80, -1));
        ...
        jPanel1.add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 170, 80, -1));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        for (Performances performance : utilisateur.getPerformances()) {
            ...
            if (existingDateString.equals(selectedDateString) && performance.getSport().estWindsurf()) {
        ...
        if (existingPerformance != null) {
            ...
            if (choice == JOptionPane.YES_OPTION) {
                ...
                WindSurf c = (WindSurf) existingPerformance.getSport();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        TestJfreeChTimeWind tj = new TestJfreeChTimeWind(this.u, true);
        tj.setVisible(true);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        //        tj.setVisible(true);
        TestJfreeChTimeWind tj = new TestJfreeChTimeWind(this.u, false);
        tj.setVisible(true);
    }//GEN-LAST:event_jButton3ActionPerformed

    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        VitesseWind v = new VitesseWind(this.u);
        v.setVisible(true);
